\section{UV-Divergences and Renormalization of the MRSSM}
...
&=i\frac{g_s^2}{16\pi^2} \Delta\epsilon \left[ - \frac{4 (n_{f}-1)}{3} T(F) + \frac{5}{3} C(A) \right](p^2g^{\mu\nu}-p^\mu p^\nu)\delta_{ab}
\end{align}
\begin{figure}[!htbp]
\begin{center}
\begin{tikzpicture}[line width=1.5 pt, scale=1.3]
...
\end{figure}
\begin{align}
i\Gamma^{\mathrm{1L,heavy}}_{q_i \overline{q}_j G_\mu^a}(p_i^2=0) = - -g_s T^a_{ij} \gamma^\mu \frac{g_s^2}{16\pi^2} &\left[ \left(C(F) -\frac{C(A)}{2}\right) 4C_{00}(0, 0, m_{\tilde{g}}^2, m_{\tilde{q}}^2, m_{\tilde{q}}^2) \right.\nonumber\\
&+ \left. C(A)\left( B_0(0, m_{\tilde{g}}^2, m_{\tilde{q}}^2) -2C_{00}(0, 0, m_{\tilde{g}}^2, m_{\tilde{g}}^2, m_{\tilde{q}}^2)\right) \right]
\end{align}
