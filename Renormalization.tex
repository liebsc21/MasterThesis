...
%\begin{lstlistings}
Amp[{{F[3, {1, Col1}], k[1], 0, {}}} -> {{F[3, {1, Col2}], k[2], 
     0, {}}}][(1/(\[Pi]^2))
  g3^2 ((1/6 + Dminus4/12) (B0i[bb0, Pair[k[1], k[1]], 0, 0] + 
        B0i[bb1, Pair[k[1], k[1]], 0, 0]) - 
     1/6 B0i[bb1, Pair[k[1], k[1]], MassGlu^2, MassSu[1]^2]) Mat[(
SequenceForm["<", "u", 2, "|", 6, ",", 
FormCalc`k[1], "|", "u", 1, ">"]) SUNT[Col1, Col2]] + (1/(\[Pi]^2))
  g3^2 ((1/6 + Dminus4/12) (B0i[bb0, Pair[k[1], k[1]], 0, 0] + 
        B0i[bb1, Pair[k[1], k[1]], 0, 0]) - 
     1/6 B0i[bb1, Pair[k[1], k[1]], MassGlu^2, MassSu[4]^2]) Mat[(
SequenceForm["<", "u", 2, "|", 7, ",", 
FormCalc`k[1], "|", "u", 1, ">"]) SUNT[Col1, Col2]]]
%\end{lstlistings}
