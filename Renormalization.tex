...
\mathcal{M}^{\mathrm{1L,ct}}_{\mathrm{self-energy}} &= \hdots = 
\mathcal{M}^B \left[ \frac{-(t_{\tilde{g}})\delta Z_{\tilde{g}}^L + 2 \delta m_{\tilde{g}}m_{\tilde{g}}}{t_{\tilde{g}}}\right.\\
&\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \left. \frac{-(u_{\tilde{g}})\delta Z_{\tilde{g}}^L + 2 \delta m_{\tilde{g}}m_{\tilde{g}}}{u_{\tilde{g}}}\right]
\end{align}
\begin{figure}[!htbp]
\begin{center}
\begin{tikzpicture}[line width=1 pt, scale=1]
	...
	\node at (2.8,0.5) {$u$};
	\node at (2.8,-0.5) {$u$};
	\node at (5.2,0.5) {$\tilde{u}_L^\dagger$};
	\node at (5.2,-0.5) {$\tilde{u}_R^\dagger$};
	\node at (6,0) {+};
	...
	\node at (6.8,0.5) {$u$};
	\node at (6.8,-0.5) {$u$};
	\node at (9.2,0.5) {$\tilde{u}_L^\dagger$};
	\node at (9.2,-0.5) {$\tilde{u}_R^\dagger$};
\begin{scope}[shift={(8,0)}]	
	...
	\node at (5.2,0.5) {$\tilde{u}_L^\dagger$};
	\node at (5.2,-0.5) {$\tilde{u}_R^\dagger$};
	\node at (6.9,) {+\ \ u-channel};
\end{scope}
\end{tikzpicture}
\caption{1-Loop-Level Counterterm Feynman diagrams for squark production in the MRSSM}
\end{center}
\end{figure}
