...
Note that the ``chirality'' of sfermions is understood to be the chirality of their superpartners. Of course scalar particles have no chirality.
\begin{table}[H]
\begin{center}
\begin{tabular}{c?c?c}
