...
\begin{align}
\mathcal{L}_{\mathrm{Yang-Mills}} = \overline{\Psi}i\slashed{D}\Psi - \frac{1}{4}F^{a\mu\nu}F^a_{\mu\nu}
\end{align}
...
Matter particles acquire mass via Yukawa coulings to the Higgs doublet. For up-type-quarks one uses that the charge conjugate of $\Phi$: $\Phi^C = i \sigma^2 \Phi^\ast$ also transforms as $\Phi$.
\begin{align}
