...
\end{center}
\end{figure}
Again, it is clearly visible that the $K$-factors depend rather strongly on the ratio $\frac{m_{\mathrm{g}}}{m_{\mathrm{q}}}$ but not so much on the masses itself (see also fig. \ref{fig:Kfactor_MSSM}). As the real corrections are identical to those in the MRSSM, it is again these very real corrections which are responsible for an enhancement of the $K$-factor for large values of  $\frac{m_{\mathrm{g}}}{m_{\mathrm{q}}}$.
