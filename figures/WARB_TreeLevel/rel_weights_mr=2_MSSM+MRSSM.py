...
f_MRSSM1 = open('1_q+q_bar->sq+sq_dagger/MRSSM_q+q_bar->sq+sq_dagger_mr=2.txt', 'r')
...
f_MRSSM3 = open('3_q+q->sq+sq/MRSSM_q+q->sq+sq_mr=2.txt', 'r')
...
f_MRSSM4 = open('4_q+q_bar->sg+sg_bar/MRSSM_q+q_bar->sg+sg_bar_mr=2.txt', 'r')
...
f_MRSSM5 = open('5_g+g->sg+sg/MRSSM_g+g->sg+sg_bar_mr=2.txt', 'r')
...
f_MRSSM6 = open('6_q+g->sq+sg/q+g->sq+sg_mr=2.txt', 'r')
...
f_MSSM1 = open('1_q+q_bar->sq+sq_dagger/MSSM_q+q_bar->sq+sq_dagger_mr=2.txt', 'r')
...
f_MSSM3 = open('3_q+q->sq+sq/MSSM_q+q->sq+sq_mr=2.txt', 'r')
...
f_MSSM4 = open('4_q+q_bar->sg+sg_bar/MSSM_q+q_bar->sg+sg_bar_mr=2.txt', 'r')
...
f_MSSM5 = open('5_g+g->sg+sg/MSSM_g+g->sg+sg_bar_mr=2.txt', 'r')
...
f_MSSM6 = open('6_q+g->sq+sg/q+g->sq+sg_mr=2.txt', 'r')
...
first_window.text(1000, 0.95, r"$\frac{m_{\tilde{g}}}{m_{\tilde{q}}} = 2$", 
...
plt.plot(m_squark, (sigma1_MRSSM+sigma2_MRSSM)/sigma_MRSSM, lw=2, ls="--", c='red', label = r"$\tilde{q}\tilde{q}^\dagger$")
...
props = dict(boxstyle='round', facecolor='w', alpha=0.5)
second_window.text(1000, 0.95, r"$\frac{m_{\tilde{g}}}{m_{\tilde{q}}} = 2$", 
                  fontsize=22, verticalalignment='top', bbox=props)
