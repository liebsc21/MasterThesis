...
f_MSSM = open('MSSM_3_qq_sqsq_msq=1000GeV.txt', 'r')
...
f_MRSSM = open('MRSSM_3_qq_sqLsqR_msq=1000GeV.txt', 'r')
...
f_MRSSM_minScale = open('Errors/qq_to_sqsq_MRSSM_minScaleError_msq=1000GeV.txt', 'r')
...
f_MSSM_maxPdf = open('Errors/qq_to_sqsq_MSSM_maxPdfError_msq=1000GeV.txt', 'r')
for lines in f_MSSM_maxPdf.readlines():
    sigma3_MSSM_maxPdf = np.append(sigma3_MSSM_maxPdf, float(lines))
f_MSSM_maxPdf.close()

f_MSSM_minPdf = open('Errors/qq_to_sqsq_MSSM_minPdfError_msq=1000GeV.txt', 'r')
for lines in f_MSSM_minPdf.readlines():
    sigma3_MSSM_minPdf = np.append(sigma3_MSSM_minPdf, float(lines))
f_MSSM_minPdf.close()

f_MSSM_maxScale = open('Errors/qq_to_sqsq_MSSM_maxScaleError_msq=1000GeV.txt', 'r')
...
f_MSSM_minScale = open('Errors/qq_to_sqsq_MSSM_minScaleError_msq=1000GeV.txt', 'r')
...
first_window.fill_between(m_gluino, sigma_MSSM - sigma_MSSM_min, sigma_MSSM + sigma_MSSM_max, facecolor=[80./100,80./100,1], color =[80./100,80./100,1], linestyle="-")
first_window.fill_between(m_gluino, sigma_MRSSM - sigma_MRSSM_min, sigma_MRSSM + sigma_MRSSM_max, facecolor=[1,80./100,80./100], color =[1,80./100,80./100], linestyle="-")
plt.plot(m_gluino, sigma_MSSM, lw=2, ls="-", c='blue', label = "MSSM")
plt.plot(m_gluino, sigma_MRSSM, lw=2, ls="-", c='red', label = "MRSSM")
