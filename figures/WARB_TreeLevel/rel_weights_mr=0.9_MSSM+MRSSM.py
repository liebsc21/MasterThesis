...
f_MRSSM1 = open('1_q+q_bar->sq+sq_dagger/MRSSM_q+q_bar->sq+sq_dagger_mr=0.9.txt', 'r')
...
f_MRSSM3 = open('3_q+q->sq+sq/MRSSM_q+q->sq+sq_mr=0.9.txt', 'r')
...
f_MRSSM4 = open('4_q+q_bar->sg+sg_bar/MRSSM_q+q_bar->sg+sg_bar_mr=0.9.txt', 'r')
...
f_MRSSM5 = open('5_g+g->sg+sg/MRSSM_g+g->sg+sg_bar_mr=0.9.txt', 'r')
...
f_MRSSM6 = open('6_q+g->sq+sg/q+g->sq+sg_mr=0.9.txt', 'r')
...
f_MSSM1 = open('1_q+q_bar->sq+sq_dagger/MSSM_q+q_bar->sq+sq_dagger_mr=0.9.txt', 'r')
...
f_MSSM3 = open('3_q+q->sq+sq/MSSM_q+q->sq+sq_mr=0.9.txt', 'r')
...
f_MSSM4 = open('4_q+q_bar->sg+sg_bar/MSSM_q+q_bar->sg+sg_bar_mr=0.9.txt', 'r')
...
f_MSSM5 = open('5_g+g->sg+sg/MSSM_g+g->sg+sg_bar_mr=0.9.txt', 'r')
...
f_MSSM6 = open('6_q+g->sq+sg/q+g->sq+sg_mr=0.9.txt', 'r')
...
#fig.suptitle(r'fraction of final states for sparticle production at the LHC at $\sqrt{s}=13$TeV', fontsize=25)

first_window = plt.subplot(121)
plt.title(r"MSSM", size = 22)
plt.xlabel(r"$m_{\tilde{q}}$ in GeV", size = 22)
plt.ylabel("fraction of final states", size = 22)
...
plt.plot(m_squark, (sigma1_MSSM+sigma2_MSSM)/sigma_MSSM, lw=2, ls="--", c='red', label = r"$\tilde{q}\tilde{q}^\dagger$")
plt.plot(m_squark, sigma3_MSSM/sigma_MSSM, lw=2, ls="-", c='green', label = r"$\tilde{q}\tilde{q}$")
#plt.plot(m_squark, savitzky_golay(sigma3_MSSM/sigma_MSSM,51,3), lw=2, ls="-", c='green', label = r"$\tilde{q}\tilde{q}$")
plt.plot(m_squark, (sigma4_MSSM+sigma5_MSSM)/sigma_MSSM, lw=2, ls=":", c='darkblue', label = r"$\tilde{g}\tilde{g}$")
#plt.plot(m_squark, savitzky_golay(sigma6_MSSM/sigma_MSSM,11,7), lw=2, ls="-.", c='black', label = r"$\tilde{g}\tilde{q}$")
plt.plot(m_squark, sigma6_MSSM/sigma_MSSM, lw=2, ls="-.", c='black', label = r"$\tilde{g}\tilde{q}$")


plt.legend(loc='best',prop={'size':21})

props = dict(boxstyle='round', facecolor='w', alpha=0.5)
first_window.text(700, 0.85, r"$\frac{m_{\tilde{g}}}{m_{\tilde{q}}} = 0.9$", 
...
plt.plot(m_squark, (sigma1_MRSSM+sigma2_MRSSM)/sigma_MRSSM, ls="--", lw=2, c='red', label = r"$\tilde{q}\tilde{q}^\dagger$")
plt.plot(m_squark, sigma3_MRSSM/sigma_MRSSM, lw=2, ls="-", c='green', label = r"$\tilde{q}\tilde{q}$")
plt.plot(m_squark, (sigma4_MRSSM+sigma5_MRSSM)/sigma_MRSSM, lw=2, ls=":", c='darkblue', label = r"$\tilde{g}\overline{\tilde{g}}$")
plt.plot(m_squark, sigma6_MRSSM/sigma_MRSSM, lw=2, ls="-.", c='black', label = r"$\tilde{g}\tilde{q}$")


plt.legend(loc='best',prop={'size':22})

props = dict(boxstyle='round', facecolor='w', alpha=0.5)
second_window.text(700, 0.85, r"$\frac{m_{\tilde{g}}}{m_{\tilde{q}}} = 0.9$", 
                  fontsize=22, verticalalignment='top', bbox=props)
