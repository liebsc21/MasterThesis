...
sigma_MSSM  = sigma1_MSSM+sigma2+sigma3_MSSM+sigma4_MSSM+sigma5_MSSM+sigma6
sigma_MRSSM = sigma1_MRSSM+sigma2+sigma3_MRSSM+sigma4_MRSSM+sigma5_MRSSM+sigma6
sigma_min = 0
sigma_max = 1
...
plt.ylabel(r"fraction of final states", size = 22)
...
plt.plot(m_squark, (sigma1_MSSM+sigma2)/sigma_MSSM, lw=2, ls="--", c='red', label = r"$\tilde{q}\tilde{q}^\dagger$")
...
plt.plot(m_squark, sigma6/sigma_MSSM, lw=2, ls="-.", c='black', label = r"$\tilde{q}\tilde{g}$")

plt.legend(loc=1,prop={'size':21})

props = dict(boxstyle='round', facecolor='w', alpha=0.5)
first_window.text(800, 0.8, r"$\frac{m_{\tilde{g}}}{m_{\tilde{q}}} = 5.0$", fontsize=22,
...
#plt.plot(m_squark, sigma6, lw=2, ls="-.", c='black', label = r"$qG \to \tilde{q}\tilde{g}$")
plt.plot(m_squark, (sigma1_MRSSM+sigma2)/sigma_MRSSM, lw=2, ls="--", c='red', label = r"$\tilde{q}\tilde{q}^\dagger$")
...
plt.plot(m_squark, sigma6/sigma_MRSSM, lw=2, ls="-.", c='black', label = r"$\tilde{q}\tilde{g}$")

plt.legend(loc=1,prop={'size':21})

second_window.text(800, 0.8, r"$\frac{m_{\tilde{g}}}{m_{\tilde{q}}} = 5.0$", fontsize=22,
        verticalalignment='top', bbox=props)
